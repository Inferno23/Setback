...
public class SelectTrumpView extends SetbackClientView {
	...
	public void initialize() {
		...
		super.initialize();
		// Winning bet label
		winningBet = new JLabel(controller.getWinningBid());
		...
		// TODO: Listeners should be generated by a helper method.
		spadesButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				final String response = controller.selectTrump(CardSuit.SPADES);
		...
		heartsButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
        final String response = controller.selectTrump(CardSuit.HEARTS);
		...
		clubsButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
        final String response = controller.selectTrump(CardSuit.CLUBS);
		...
		diamondsButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
        final String response = controller.selectTrump(CardSuit.DIAMONDS);
