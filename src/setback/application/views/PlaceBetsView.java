...
public class PlaceBetsView extends SetbackClientView {
	...
	private void bettingInitialization() {
		...
		// TODO: Action listeners should be generated by a helper method
		passButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				final String response = controller.placeBid(Bet.PASS);
		...
		twoButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				final String response = controller.placeBid(Bet.TWO);
		...
		threeButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				final String response = controller.placeBid(Bet.THREE);
		...
		fourButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				final String response = controller.placeBid(Bet.FOUR);
		...
		fiveButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				final String response = controller.placeBid(Bet.FIVE);
		...
		takeButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				final String response = controller.placeBid(Bet.TAKE);
