...
public class PlayerControllerTest {
	...
	public void noCommandInput() {
		final String result = controllerOne.processInput(
				CommandMessageJson.constructCommandMessage(Command.NO_COMMAND));
		final String expected = "No command";
		assertEquals(expected, result);
	}
	...
	public void exitInput() {
		final String result = controllerOne.processInput(
				CommandMessageJson.constructCommandMessage(Command.EXIT));
	...
	public void requestPlayerOneSelected() {
		final String result = controllerOne.processInput(
				CommandMessageJson.constructCommandMessage(Command.REQUEST_PLAYER_ONE));
	...
	public void requestPlayerTwoSelected() {
		final String result = controllerOne.processInput(
				CommandMessageJson.constructCommandMessage(Command.REQUEST_PLAYER_TWO));
	...
	public void requestPlayerThreeSelected() {
		final String result = controllerOne.processInput(
				CommandMessageJson.constructCommandMessage(Command.REQUEST_PLAYER_THREE));
	...
	public void requestPlayerFourSelected() {
		final String result = controllerOne.processInput(
				CommandMessageJson.constructCommandMessage(Command.REQUEST_PLAYER_FOUR));
	...
	public void attemptBetWithoutFourPlayers() {
		...
		controllerOne.processInput(
				CommandMessageJson.constructCommandMessage(Command.REQUEST_PLAYER_ONE));
		final String result = controllerOne.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLACE_BET, arguments));
	...
	public void showHandProperly() {
		...
		final String result = controllerOne.processInput(
				CommandMessageJson.constructCommandMessage(Command.SHOW_HAND));
	...
	public void getCurrentPlayerWithoutFourPlayers() {
		final String result = controllerOne.processInput(
				CommandMessageJson.constructCommandMessage(Command.GET_CURRENT_PLAYER));
	...
	public void playerTwoValidBet() {
		initializeFourControllers();
		final String arguments[] = {"PASS"};
		final String result = controllerTwo.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLACE_BET, arguments));
	...
	public void playerOneSelectsSpades() {
		...
		final String result = controllerOne.processInput(
				CommandMessageJson.constructCommandMessage(Command.SELECT_TRUMP, spades));
	...
	public void playerOneDiscardsProperly() {
		...
		final String result = controllerOne.processInput(
				CommandMessageJson.constructCommandMessage(Command.DISCARD_CARDS, discardOne));
	...
	public void playerOnePlaysValidCard() {
		...
		final String result = controllerOne.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, card));
	...
	public void fullTrickPlayed() {
		...
		controllerOne.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardOne));
		controllerTwo.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardTwo));
		controllerThree.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardThree));
		controllerFour.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardFour));
	}
	...
	public void teamOneScore() {
		initializeFourControllers();
		final String result = controllerOne.processInput(
				CommandMessageJson.constructCommandMessage(Command.GET_TEAM_ONE_SCORE));
	...
	public void teamTwoScore() {
		initializeFourControllers();
		final String result = controllerOne.processInput(
				CommandMessageJson.constructCommandMessage(Command.GET_TEAM_TWO_SCORE));
		final String expected = "0";
		assertEquals(expected, result);
	}
	...
	private void playerOneWinsBet() {
		...
		controllerTwo.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLACE_BET, pass));
		controllerThree.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLACE_BET, pass));
		controllerFour.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLACE_BET, pass));
		controllerOne.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLACE_BET, two));
	}
	...
	private void beginFirstTrick() {
		...
		controllerOne.processInput(
				CommandMessageJson.constructCommandMessage(Command.DISCARD_CARDS, discardOne));
		controllerTwo.processInput(
				CommandMessageJson.constructCommandMessage(Command.DISCARD_CARDS, discardTwo));
		controllerThree.processInput(
				CommandMessageJson.constructCommandMessage(Command.DISCARD_CARDS, discardThree));
		controllerFour.processInput(
				CommandMessageJson.constructCommandMessage(Command.DISCARD_CARDS, discardFour));
	}
	...
	private void playFullFirstRound() {
		...
		controllerOne.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardOneOne));
		controllerTwo.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardTwoOne));
		controllerThree.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardThreeOne));
		controllerFour.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardFourOne));
		// Trick two
		...
		controllerOne.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardOneTwo));
		controllerTwo.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardTwoTwo));
		controllerThree.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardThreeTwo));
		controllerFour.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardFourTwo));
		// Trick three
		...
		controllerThree.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardThreeThree));
		controllerFour.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardFourThree));
		controllerOne.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardOneThree));
		controllerTwo.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardTwoThree));
		// Trick four
		...
		controllerThree.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardThreeFour));
		controllerFour.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardFourFour));
		controllerOne.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardOneFour));
		controllerTwo.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardTwoFour));
		// Trick five
		...
		controllerOne.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardOneFive));
		controllerTwo.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardTwoFive));
		controllerThree.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardThreeFive));
		controllerFour.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardFourFive));
		// Trick six
		...
		controllerOne.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardOneSix));
		controllerTwo.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardTwoSix));
		controllerThree.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardThreeSix));
		controllerFour.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardFourSix));
		// Trick seven
		...
		controllerOne.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardOneSeven));
		controllerTwo.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardTwoSeven));
		controllerThree.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardThreeSeven));
		controllerFour.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardFourSeven));
		// Trick Eight
		...
		controllerOne.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardOneEight));
		controllerTwo.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardTwoEight));
		controllerThree.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardThreeEight));
		controllerFour.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardFourEight));
		// Trick Nine
		...
		controllerOne.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardOneNine));
		controllerTwo.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardTwoNine));
		controllerThree.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardThreeNine));
		controllerFour.processInput(
				CommandMessageJson.constructCommandMessage(Command.PLAY_CARD, cardFourNine));
	}
}
